...
class HighlightView {
    ...
    private void initStyles(Context context) {
        ...
        context.getTheme().resolveAttribute(com.sharpnode.R.attr.cropImageStyle, outValue, true);
        TypedArray attributes = context.obtainStyledAttributes(outValue.resourceId, com.sharpnode.R.styleable.CropImageView);
        try {
            showThirds = attributes.getBoolean(com.sharpnode.R.styleable.CropImageView_showThirds, false);
            showCircle = attributes.getBoolean(com.sharpnode.R.styleable.CropImageView_showCircle, false);
            highlightColor = attributes.getColor(com.sharpnode.R.styleable.CropImageView_highlightColor,
                    DEFAULT_HIGHLIGHT_COLOR);
            handleMode = HandleMode.values()[attributes.getInt(com.sharpnode.R.styleable.CropImageView_showHandles, 0)];
        } finally {
            attributes.recycle();
        }
    }
    ...
    void handleMotion(int edge, float dx, float dy) {
        ...
        if (edge == MOVE) {
            ...
            Log.d("LTRB", "" + GROW_LEFT_EDGE + " " + GROW_TOP_EDGE + " " + GROW_RIGHT_EDGE + " " + GROW_BOTTOM_EDGE);
