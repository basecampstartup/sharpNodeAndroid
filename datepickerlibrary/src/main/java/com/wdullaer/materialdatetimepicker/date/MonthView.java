...
public abstract class MonthView extends View {
    ...
    protected void initView() {
        ...
        //Made change for set the day's(i.e, M,T etc) color white in case of birthday only.
        if (DatePickerDialog.isYearGone) {
            mMonthDayLabelPaint.setColor(Color.WHITE);
        } else {
    ...
    private String getMonthAndYearString() {
        ...
        String monthYear = DateUtils.formatDateRange(getContext(), mFormatter, millis, millis, flags,
